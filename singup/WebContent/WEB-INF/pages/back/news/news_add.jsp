...
<base href="<%=basePath%>">
<%
	String addNewsUrl = basePath + "admin/news/add.action" ;
%>
				...
				<div class="panel-body">
					<form action="<%=addNewsUrl%>" id="myform" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-group" id="dtidDiv">
							...
							<div class="col-md-5">
								<select id="dtid" name="dtid" class="form-control">
									...
									<option value="${dct.dtid}">${dct.title}</option>  
									</c:forEach>
								
								</select>
							</div> 
							<div class="col-md-4" id="dtidMsg">*</div>
						</div>
						...
						<div class="form-group" id="contentDiv">
							<label class="col-md-2 control-label" for="content">公告内容：</label>
							<div class="col-md-9">
						...
						<div class="form-group" id="flagDiv">
							...
							<div class="col-md-5">
								<div class="radio-inline">
									<input type="radio" id="flag" name="flag" checked value="1">直接发布
								</div>
								<div class="radio-inline">
									<input type="radio" id="flag" name="flag" value="0">暂存草稿
								</div>
							</div>
