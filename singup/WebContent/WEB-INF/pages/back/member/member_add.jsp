...
<base href="<%=basePath%>">
<%
	String addMemberUrl = basePath + "admin/member/add.action" ;
%>
		...
		<div class="content-wrapper">
			<div class="panel panel-success">
				<div class="panel-heading">
					<strong><i class="fa fa-user-md"></i>&nbsp;创建管理员账户</strong>
				</div>
				<div class="panel-body">
					<form action="<%=addMemberUrl%>" id="myform" method="post" class="form-horizontal">
						<div class="form-group" id="midDiv">
							...
							<div class="col-md-5">
								<input type="text" name="mid" id="mid" class="form-control input-sm" placeholder="请输入要注册的用户名">
							</div>
						...
						<div class="form-group" id="passwordDiv">
							...
							<div class="col-md-5">
								<input type="text" name="password" id="password" class="form-control input-sm" placeholder="请输入雇员密码">
							</div>
